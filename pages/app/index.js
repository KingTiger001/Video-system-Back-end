      ...
      <AppLayout>
         ...
         <div className={styles.container}>
                  ...
                  <ul className={styles.welcomeList}>
                     {!me.emailConfirmed && (
                        <li className={styles.welcomeListItem}>
                           ...
                           <span>
                              We sent an email with a confirmation link to your
                              email address. In order to complete the sign-up
                              process, please click on the confirmation link. If
            ...
            <div className={styles.stats}>
               <p
                  className={`${styles.campaignsTitle} ${styles.campaignsTitleDb}`}
               >
                  Your analytics
               </p>
...
export const getServerSideProps = withAuthServerSideProps(async () => {
   ...
   const { data: contactsCount } = await mainAPI.get(
      "/users/me/contacts/count"
   );
