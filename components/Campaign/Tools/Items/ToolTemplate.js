...
const ToolTemplate = ({ me }) => {
   ...
   const deleteNetwork = (id) => {
      const newArray = endScreen.networks.filter(
               ...
               <div className={styles.toolSection}>
                  ...
                  {endScreenList.length > 0 ? (
                     ...
                     <p className={styles.toolDescription}>
                        Here you will find your start screens created. Start by
                        creating one by clicking just above!
                     </p>
                  )}
               </div>
            )}
