                ...
                {selectedContent &&
                  ...
                  selectedContent.links.length > 0 && (
                    <>
                          ...
                          {linkPresets.map(
                            (preset) =>
                              preset !== 2 && (
                                <div
                                  className={`${styles.presetBtn} ${
                                    linkFocused.preset === preset
                                      ? styles.selected
                                      : null
                                  }`}
                                  onClick={() =>
                                    selectedContent.links.map((link) =>
                                      selectPreset(preset, link._id)
                                    )
                                  }
                                >
                                  Preset {preset <= 1 ? preset + 1 : preset}
                      ...
                      <div className={styles.styleOption}>
                        <div className={`${styles.labelControl}`}>Size</div>
                        <div
                        ...
                        <div className={`${styles.labelControl}`}>Color</div>
                        <div
                          className={`${styles.presetBtn} ${styles.selected}`}
                        >
                          <div
