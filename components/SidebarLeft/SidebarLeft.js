    ...
    return (
        <aside className={`menu ${styles.menu}`}>
            ...
            <div className={`${styles.top_group}`}>
                <Link href="/app">
                    <a className={`menu-item ${styles.menu_item} ` + (router.route === '/app' ? styles.active : '')}>
                        <span className={`${styles.orange_border}`}></span>
                        <span className={`${styles.tooltip}`}>Dashboard</span>
                        <img src="/assets/common/dashboard.png" />
                    </a>
                </Link>
                <button className={`menu-item ${styles.menu_item} ${styles.new_video}`}
                ...
                <Link href="/app/campaigns">
                    <a className={`menu-item ${styles.menu_item} ` + (router.route === '/app/campaigns' ? styles.active : '')} >
                        <span className={`${styles.orange_border}`}></span>
                ...
                <button className={`menu-item ${styles.menu_item}`}
            ...
            <div className={`${styles.bottom_group}`}>
                <Link href={'/app/upgrade'}>
                    <a className={`menu-item ${styles.menu_item} ${styles.menu_item_orange} ${styles.no_tooltip} ` + (router.route === '/app/upgrade' ? styles.active : '')}>
                        <span className={`${styles.orange_border}`}></span>
                        <p>Upgrade</p>
                    </a>
                </Link>
