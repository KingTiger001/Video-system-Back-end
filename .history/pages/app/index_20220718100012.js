...
const Dashboard = ({
  ...
  const [LastVideoInfoList, setLastVideo] = useState(LastVideoInfo);
  ...
  const getLastVideo = async () => {
    const {data: LastVideoUpdated} = await mainAPI.get(
        `/users/me/last_video?status=draft`
    );
    setLastVideo(LastVideoUpdated);
  }
    ...
    <AppLayout>
      ...
      <div className={styles.container}>
        ...
        <div className={styles.stats}>
          ...
          {LastVideoInfoList.length > 0 &&
              LastVideoInfoList.map((campaign) => {
                return <div className={styles.stateTable}>
                <div className={styles.tables}>
                  <div className={styles.perfVideo}>
                    <p className={styles.perfTitle}>Best performance</p>
                    <img src={campaign.share.thumbnail} alt="" height={133}/>
                    <br/>
                    <span className={styles.perfVideoTitle}>{campaign.name ? campaign.name : "No Name"}</span>
                  </div>
                  <div className={styles.statsShape}>
                    <div className={styles.statsShape1}>
                      <span className={styles.number}>46</span>
                      <span className={styles.text}>views</span>
                    </div>
                    <div className={styles.statsShape2}>
                      <span className={styles.number}>46</span>
                      <span className={styles.text}>views</span>
                    </div>
                    <div className={styles.statsShape3}>
                      <span className={styles.number}>46</span>
                      <span className={styles.text}>views</span>
                    </div>
                  </div>
                  ...
                  <div className={styles.tables2}>
                    ...
                    <div>
                      <div className={styles.totalViews}>
                        <span className={styles.number}>387</span>
                        <br/>
...
export const getServerSideProps = withAuthServerSideProps(async () => {
  ...
  const { data : LastVideoInfo} = await mainAPI.get("/users/me/last_video?status=draft");
  return {
    campaignsDraft,
    campaignsShared,
    contactsCount,
